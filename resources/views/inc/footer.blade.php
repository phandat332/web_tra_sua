                ...
                <div class="col-md-4 offer-footer my-md-0 my-4">
                    <div class="row">
                        <div class="col-4 icon-fot">
                            ...
                            <a href="{{URL::to('cli_poli/'.$c->policy_id)}}"><img
                                    src="{{asset('uploads/chinhsach/'.$c->image)}}" alt=""></a>
                        </div>
                        <div class="col-8 text-form-footer">
                            <a href="{{URL::to('cli_poli/'.$c->policy_id)}}">
                                <h3>{!!$c->title!!}</h3>
                            </a>
                            <p>{!!$c->sumary!!}</p>
                        </div>
        ...
        <div class="container py-md-5 py-sm-4 py-3">
            <div class="row footer-info w3-agileits-info">
                ...
                <div class="col-md-3 col-sm-6 footer-grids">
                    <h3 class=" font-weight-bold mb-3" style="color:black;font-weight:bold">@lang('lang.ProductType')
                    </h3>
                    <ul>
                ...
                <div class="col-md-3 col-sm-6 footer-grids mt-sm-0 mt-4">
                    ...
                    <ul>
                        ...
                        <li class="mb-3">
                            <a
                                href="{{URL::to('danh-muc-bai-viet/'.$cate_post1[0]->cate_post_slug)}}">@lang('lang.post')</a>
                        </li>
                        <li class="mb-3">
                ...
                <div class="col-md-3 col-sm-6 footer-grids mt-md-0 mt-4">
                    ...
                    <ul>
                        <li class="mb-3">
                            <i class="fas fa-map-marker"></i>Đại học Công nghệ Tp HCM
                        </li>
                        <li class="mb-3">
                            <i class="fas fa-mobile"></i> 0343754517
                        </li>
                        <li class="mb-3">
                            <i class="fas fa-phone"></i> 0999999999
                        </li>
                        <li class="mb-3">
                            <i class="fas fa-envelope-open"></i>
                            <a href="mailto:example@mail.com"> Trasua123@gmail.com</a>
                        </li>
                        <li>
                            <i class="fas fa-envelope-open"></i>
                            <a href="mailto:example@mail.com"> TeaMilk@gmail.com</a>
                        </li>
                    </ul>
                </div>
                <div class="col-md-3 col-sm-6 footer-grids w3l-agileits mt-md-0 mt-4">
                    <div class="footer-grids  w3l-socialmk mt-3">
                        <h3 class="font-weight-bold mb-3" style="color:black;font-weight:bold">@lang('lang.FollowUsAt')
                        </h3>
                        <div class="social">
                            <ul>
                                <li>
